            ...
            <div className="base h-screen flex justify-center items-center">
                <Card className="w-2/3 h-3/4">
                    <CardHeader className="mb-2 grid place-items-center self-center overflow-visible w-4/5 h-1/5 bg-[#eb986f] text-white">
                        <Typography className="m-4 text-balance text-center text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl font-bold">
                            <span className="modak text-3xl uppercase underline decoration-2">Step 2</span>
                            <br />
                            <span className="modak text-2xl">
                    ...
                    >
                        ...
                        <CardFooter className="flex justify-center items-center mb-6 mt-3 p-1">
                            <Button
